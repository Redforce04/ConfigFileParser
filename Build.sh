...
dotnet run --project "ReplaceTextWithVariables" ConfigFileParser/VersionInfo.cs -v "win-arm64" "osx-x64"
dotnet publish ConfigFileParser -r osx-x64 --sc true -v q -c release /p:PublishSingleFile=true;PublishTrimmed=true
dotnet run --project "ReplaceTextWithVariables" ConfigFileParser/VersionInfo.cs -v "osx-x64" "linux-x64"
